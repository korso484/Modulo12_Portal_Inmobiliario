...
import { mapPropertyListFromApiToViewModel, mapFilterToQueryParamas } from './property-list.mappers';
...
Promise.all([
    ...
    getSaleTypeList(),
    getProvincesList(),
]).then(([propertyList, salesTypeList, provincesList]) => {
...
onSubmitForm('search-button', () => {
    const queryParams = mapFilterToQueryParamas(filter);
    clearPropertyRows();
